...
class ProfileTeacherCompleteModel {
  bool? success;
  String? message;
  TeacherProfile? teacherProfile;

  ProfileTeacherCompleteModel({this.success, this.message, this.teacherProfile});

  ProfileTeacherCompleteModel.fromJson(Map<String, dynamic> json) {
