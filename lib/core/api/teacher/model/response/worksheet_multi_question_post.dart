...
class WorksheetMultiQuestionPost {
  bool? success;
  String? message;
  WorksheetMultiData? worksheetMultiData;

  WorksheetMultiQuestionPost({this.success, this.message, this.worksheetMultiData});

  WorksheetMultiQuestionPost.fromJson(Map<String, dynamic> json) {
