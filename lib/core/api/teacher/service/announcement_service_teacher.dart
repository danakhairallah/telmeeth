...
class AnnouncementServiceTeacher {
  Future<List<AnnouncementTeacher>> getAnnouncements() async {
    ...
    print("🟠 [AnnouncementServiceTeacher] Token used: $token");

    print("🔵 CALLING API: /teacher/announcements");
    try {
      ...
      return (data as List)
          .map((e) => AnnouncementTeacher.fromJson(e))
          .toList();
    } catch (e) {
      print("🔴 Error in getAnnouncements: $e");
      // هنا رجع قائمة فاضية إذا صار خطأ
      return [];
    }
  }
