...
class TeacherUploadService {
  ...
  Future<StdTeacherUplodeSubjectModel?> getTeacherUplodeById(int subjectId) async {
    try {
      final dio = await ApiClient.getDio();

      final response = await dio.get("/student/teacher-uploads/subject/$subjectId");
      ...
      if (response.statusCode == 200) {
        if (response.statusCode == 200) {
          ...
          return StdTeacherUplodeSubjectModel.fromJson(mapData);
        }
