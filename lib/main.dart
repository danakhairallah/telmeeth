  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // ================= PARENT PORTAL =================
        ChangeNotifierProvider(create: (_) => BusController(BusService())),
        ChangeNotifierProvider(create: (_) => TicketController(TicketService())),
        ChangeNotifierProvider(create: (_) => WalkingTimeController()),
        ChangeNotifierProvider(create: (_) => AttendanceParentController()),
        ...
        ChangeNotifierProvider(create: (_) => SemesterDaysController(SemesterDaysService())),
        ChangeNotifierProvider(create: (_) => TimeTableControllerParent()),
        ChangeNotifierProvider(create: (_) => ParentExamController()),
        ChangeNotifierProvider(create: (_) => WorksheetParentController()),
        ChangeNotifierProvider(
          create: (_) => TaskControllerParent(TaskService()),
