...
import 'package:telmeeth/features/landing/view/pages/student/recorded_lesson_page.dart';
...
class _HomeStudentState extends State<HomeStudent> {
  ...
  final List<FeatureModel> features = [
    ...
    FeatureModel(title: 'ClassSchedule', image: 'assets/image/feature_sample.png', page: const ClassSchedule()),
    ...
    FeatureModel(title: 'GradesResults', image: 'assets/image/feature_sample.png', page: const GradesResults()),
    FeatureModel(title: 'LiveLessons', image: 'assets/image/feature_sample.png', page: const LiveLessons()),
    ...
    FeatureModel(title: 'SchedulePage', image: 'assets/image/feature_sample.png', page: const SchedulePage()),
    FeatureModel(title: 'Bus Details', image: 'assets/image/feature_sample.png', page: const BusDetailsPage()),
    FeatureModel(title: 'SchoolDays', image: 'assets/image/feature_sample.png', page: const SchoolDays()),
    FeatureModel(title: 'SmartAssistant', image: 'assets/image/feature_sample.png', page: const SmartAssistant()),
    FeatureModel(title: 'StudentFilePage', image: 'assets/image/feature_sample.png', page: const StudentFilePage()),
    FeatureModel(title: 'StudyPlan', image: 'assets/image/feature_sample.png', page: const StudyPlan()),
